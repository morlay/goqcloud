...
func (req *InquiryPriceResizeInstanceDisksRequest) Invoke(client github_com_morlay_goqcloud.Client) (*InquiryPriceResizeInstanceDisksResponse, error) {
	resp := &InquiryPriceResizeInstanceDisksResponse{}
	err := client.Request("cvm", "InquiryPriceResizeInstanceDisks", "2017-03-12").Do(req, resp)
	return resp, err
}

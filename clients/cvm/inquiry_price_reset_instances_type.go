...
func (req *InquiryPriceResetInstancesTypeRequest) Invoke(client github_com_morlay_goqcloud.Client) (*InquiryPriceResetInstancesTypeResponse, error) {
	resp := &InquiryPriceResetInstancesTypeResponse{}
	err := client.Request("cvm", "InquiryPriceResetInstancesType", "2017-03-12").Do(req, resp)
	return resp, err
}

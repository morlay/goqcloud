...
func (req *InquiryPriceResetInstanceRequest) Invoke(client github_com_morlay_goqcloud.Client) (*InquiryPriceResetInstanceResponse, error) {
	resp := &InquiryPriceResetInstanceResponse{}
	err := client.Request("cvm", "InquiryPriceResetInstance", "2017-03-12").Do(req, resp)
	return resp, err
}
